...
<head>
    ...
    <link rel="stylesheet" href="./ejer03require.css">
</head>
<body>
    <header>
        <h3>Ejercicio 03 Require</h3>
    </header>
    <div class="contenido">
    <?php
            echo "<br>";
            echo "<h3>En este ejemplo se utiliza la funcion require():</h3>"; echo "<br>";
            
            echo "<h3>Aqui ya se ejecuto la funcion require():</h3>"; echo "<br>";
            echo "<h3>Las dos variables de array de tipo asociativo son:</h3>"; echo "<br>";
            require("./ejer03require.inc");
